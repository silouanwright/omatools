...
```bash
qmlpack add oma-ui-kit github:silouanwright/omatools/packages/oma-ui-kit@0.1.6
```
...
```bash
qmlpack add oma-command-layer github:silouanwright/omatools/packages/oma-command-layer@0.2.6
```
